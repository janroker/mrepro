...
int GetUDP_addrinfo(char *node, char *service, struct addrinfo **res, int flags, status_t status, errLevel_t errLvl,
                    char *message);

int GetTCP_addrinfo(char *node, char *service, struct addrinfo **res, int flags, status_t status, errLevel_t errLvl,
                    char *message);
